...
"""
    struct: QuantumModel_Cache{T,M,S,L} <: Abstract_QuantumModel_Cache{T,M}
        model::M
        potential::DependentField{Hermitian{T,Matrix{S,S,T,L}},Matrix{T}}
        derivative::DependentField{Matrix{Hermitian{T,Matrix{S,S,T,L}}},Matrix{T}}
        eigen::DependentField{LinearAlgebra.Eigen{T,T,Matrix{S,S,T,L},SVector{S,T}},Matrix{T}}
        adiabatic_derivative::DependentField{Matrix{Matrix{S,S,T,L}},Matrix{T}}
        nonadiabatic_coupling::DependentField{Matrix{Matrix{S,S,T,L}},Matrix{T}}
        stats::Dict{Symbol,Int}
...
"""
    struct: RingPolymer_QuantumModel_Cache{T,M,S,L} <: Abstract_QuantumModel_Cache{T,M}
        ...
        traceless_potential::DependentField{Vector{Hermitian{T,Matrix{S,S,T,L}}},Array{T,3}}
        V̄::DependentField{Vector{T},Array{T,3}}
        traceless_derivative::DependentField{Array{Hermitian{T,Matrix{S,S,T,L}},3},Array{T,3}}
        D̄::DependentField{Array{T,3},Array{T,3}}
        traceless_adiabatic_derivative::DependentField{Array{Matrix{S,S,T,L},3},Array{T,3}}

        centroid::DependentField{Matrix{T},Array{T,3}}
        centroid_potential::DependentField{Hermitian{T,Matrix{S,S,T,L}},Array{T,3}}
        centroid_derivative::DependentField{Matrix{Hermitian{T,Matrix{S,S,T,L}}},Array{T,3}}
        centroid_eigen::DependentField{LinearAlgebra.Eigen{T,T,Matrix{S,S,T,L},SVector{S,T}},Array{T,3}}
        centroid_adiabatic_derivative::DependentField{Matrix{Matrix{S,S,T,L}},Array{T,3}}
        centroid_nonadiabatic_coupling::DependentField{Matrix{Matrix{S,S,T,L}},Array{T,3}}
...
struct RingPolymer_QuantumModel_Cache{T,M,S,L} <: Abstract_QuantumModel_Cache{T,M}
    model::M
    potential::DependentField{Vector{Hermitian{T,Matrix{S,S,T,L}}},Array{T,3}}
    derivative::DependentField{Array{Hermitian{T,Matrix{S,S,T,L}},3},Array{T,3}}
    eigen::DependentField{Vector{LinearAlgebra.Eigen{T,T,Matrix{S,S,T,L},SVector{S,T}}},Array{T,3}}
    adiabatic_derivative::DependentField{Array{Matrix{S,S,T,L},3},Array{T,3}}
    nonadiabatic_coupling::DependentField{Array{Matrix{S,S,T,L},3},Array{T,3}}
...
struct RingPolymer_QuantumFrictionModel_Cache{T,M,S,L} <: Abstract_QuantumModel_Cache{T,M}
    ...
    adiabatic_derivative::DependentField{Array{Matrix{S,S,T,L},3}, Array{T,3}}
    nonadiabatic_coupling::DependentField{Array{Matrix{S,S,T,L},3}, Array{T,3}}
    friction::DependentField{Array{Matrix{S,S,T,L},3}, Array{T,3}}
